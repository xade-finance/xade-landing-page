          ...
          <div className="wrap-overflow">
            ...
            <div className="article-box" style={{ backgroundColor: "#fFd84e" }}>
              ...
              <div className="right-flex-article">
                <p style={{ textAlign: "left" }}>
                  <br />
                  <br /> Get secured loans against multiple real world tokenized
                  assets without any credit score check and at competitive rates
                  with our super app
                  <br />
                </p>
                {/* <button
          ...
          <div className="row">
            ...
            <div className="col-sm-2">
              ...
              <ul className="list-unstyled">
                ...
                <li>
                  <a href="tel:+919836711182" target="_blank">
                    Phone
                  </a>
                </li>
              </ul>
